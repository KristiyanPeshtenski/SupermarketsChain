...
namespace SupermarketChain
{
    public class SqlServerToPdfReport
    {
        ...
        {
            var salesReportData = GetSalesData(startDate, endDate);
        ...
        {
            DataTable dt = CreateTableForReport(startDate, endDate);
            Document document = new Document();
            PdfWriter writer = PdfWriter.GetInstance(document, new FileStream(@"C:\Users\Rosen\Desktop\Sales-Report.pdf", FileMode.Create));
            document.Open();
            ...
            document.Add(table);
            document.Close();
            return "Generating PDF Sales Reports: Done!";
        }
    }
}
